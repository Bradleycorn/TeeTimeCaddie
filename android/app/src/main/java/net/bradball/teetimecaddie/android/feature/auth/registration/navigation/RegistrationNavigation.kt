...
fun NavHostController.navigateToRegistration(navOptions: NavOptions? = clearBackStack(navHostController = this)) {
...
fun NavGraphBuilder.registrationGraph(
    ...
    navigation(
        ...
        composable(route = registrationRoute) {
            RegistrationRoute(onLoginClick, onRegistrationComplete)
        }
