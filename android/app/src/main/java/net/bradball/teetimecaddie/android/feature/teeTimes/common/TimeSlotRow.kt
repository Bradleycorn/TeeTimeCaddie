...
import net.bradball.teetimecaddie.core.models.previewTeeTimeSlot
import net.bradball.teetimecaddie.features.teetimes.TTR

/**
 * A row displaying a single tee time slot with time, player count slider, and delete button.
 *
 * @param slot The tee time slot to display.
 * @param onUpdatePlayerCount Called when the player count slider value changes.
 * @param onRemove Called when the delete button is clicked.
 */
@Composable
fun TimeSlotRow(
    slot: TeeTimeSlot,
