 ...
 */
@Composable
fun LoadingDots(type: LoadingIndicatorTypes = LoadingIndicatorTypes.Pulsing, dotSize: Dp = 12.dp, modifier: Modifier = Modifier, color: Color = Color.Unspecified) {
    val numberOfDots = 3
 ...
 */
@Composable
private fun Dot(modifier: Modifier = Modifier, color: Color = LocalContentColor.current) {
...
fun FlashingPreview() {
    ...
    MyApplicationTheme {
        Surface {
            LoadingDots(type = LoadingIndicatorTypes.Flashing)
        }
    }
}
...
fun BouncingPreview() {
    MyApplicationTheme {
        Surface {
            LoadingDots(type = LoadingIndicatorTypes.Bouncing)
        }
    }
}